...
@section('content')
    @include('layouts.navbars.auth.topnav', ['title' => 'Funcion'])
        ...
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title">Nueva funcion de Area</h4>
                </div>
                <form id="formcreate" action="{{ route('funcion.create') }}" method="post">
                    {{ csrf_field() }}
        ...
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span
                            aria-hidden="true"></span></button>
                    <h4 class="modal-title">Editar funcion de Area</h4>
                </div>
                <form id="formupdate" method="post">
                    ...
                    <div class="modal-body">
                        <div class="row">
                            <div class="col-md-6">
                                <small>Area</small>
                                <select name="area" id="area-edit" class="form-control">
                                    @forelse ($area as $item)
                                        <option value="{{ $item->id }}">{{ $item->area }}</option>
                                    @empty
                                        <option value="null">SIN OPCIONES</option>
