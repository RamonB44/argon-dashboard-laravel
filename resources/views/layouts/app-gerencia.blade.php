        ...
        <header class="navbar navbar-expand-md navbar-dark navbar-overlap d-print-none">
          <div class="container-xl">
            ...
            <h1 class="navbar-brand navbar-brand-autodark d-none-navbar-horizontal pe-0 pe-md-3">
              <a href=".">
                <img src="./static/logo-white.svg" width="110" height="32" alt="EzAttend" class="navbar-brand-image">
              </a>
            </h1>
             ...
             data-bs-placement="bottom">
              ...
              <div class="nav-item dropdown">
                ...
                <a href="{{ url('/') }}" class="nav-link d-flex lh-1 text-reset p-0" data-bs-toggle="dropdown" aria-label="Open user menu">
                  <span class="avatar avatar-sm" style="background-image: url({{ asset('dist/static/avatars/000f.jpg')}})"></span>
