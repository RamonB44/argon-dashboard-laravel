...
@section('content')
    @include('layouts.navbars.auth.topnav', ['title' => 'Crear Usuarios'])
                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="offset-md-2  col-md-4">
                                ...
                                @endif
                                <input type="text" class="form-control" name="name" id="name" {{ $errors->has('name') ? 'is-invalid' : '' }} value="{{ old('name') }}" autofocus>
                            </div>
                            <div class="col-md-4">
                                <small>Rol</small>
                            ...
                            <div class="col-md-11">
                                ...
                                <select name="areas[]" id="areas" class="form-control" multiple="multiple">
                                    @foreach ($areas as $item)
                                        <option selected value="{{ $item->id }}">{{ $item->area }}</option>
                                    @endforeach
                                </select>
                            </div>
                            <div class="col-md-11">
