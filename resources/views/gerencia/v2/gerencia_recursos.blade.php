...
@section('content')
    ...
    <div id="carouselExampleFade" class="carousel slide carousel-fade row" data-interval="false" data-ride="carousel">
        ...
        <div class="carousel-item active">
            <div class="row justify-content-between mb-2">
                ...
                <div class="col-md bd-highlight mb-2">
                    <select class="form-control" name="cultivo" id="cultivo">
                        ...
                        @foreach (\App\Models\Procesos::whereIn(
            'id',
            \DB::table('areas_sedes')->whereIn('id_sede', $config['sedes'])->select('id_proceso')->distinct('id_proceso')->get()->pluck('id_proceso')->toArray(),
        )->get() as $item)
                ...
                <div class="col-md bd-highlight m-auto" data-step="3"
                    data-intro="Con este boton controlas el rango de fechas de todos los graficos.">
            ...
            <div id="response_jefes" class="row text-white text-center mb-3"
                style="border-bottom: 1px solid rgb(93, 60, 129);border-top: 1px solid rgb(93, 60, 129)" hidden>
                <div class="dropdown col-md"
                    style="border-bottom: 0.1px double rgb(93, 60, 129);border-top: 0.1px double rgb(93, 60, 129)">
                    <a href="#" class="disabled" id="dropdownMenuLink" style="color: #89b545; " data-toggle="dropdown"
                ...
                <div class="dropdown col-md"
                    style="border-bottom: 0.1px double rgb(93, 60, 129);border-top: 0.1px double rgb(93, 60, 129)">
                    <a href="#" class="disabled" id="dropdownMenuLink" style="color: #89b545"
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="chart">
                                ...
                                <canvas id="pieChart"
                                    style="height: 500px; min-height: 230px; display: block; width: 500px;" width="487"
        ...
        <div class="carousel-item">
            <div class="row mb-2">
                ...
                <div class="col-md">
                    <a class="btn btn-outline-primary btn-lg btn-block" data-target="#carouselExampleFade"
                        data-slide-to="0">Regresar</a>
                </div>
            </div>
...
@section('css')
    ...
    <link rel="stylesheet" type="text/css"
        href="https://cdnjs.cloudflare.com/ajax/libs/pace/1.0.2/themes/green/pace-theme-flash.min.css" />
...
@section('js')
    ...
    <script type="text/javascript"
        src="https://cdn.datatables.net/v/bs4/jszip-2.5.0/dt-1.10.21/af-2.3.5/b-1.6.2/b-colvis-1.6.2/b-flash-1.6.2/b-html5-1.6.2/b-print-1.6.2/cr-1.5.2/fc-3.3.1/fh-3.1.7/kt-2.5.2/r-2.2.5/rg-1.1.2/rr-1.2.7/sc-2.0.2/sp-1.1.1/sl-1.3.1/datatables.min.js">
    </script>
    <script type="text/javascript" src="//cdnjs.cloudflare.com/ajax/libs/pace/1.0.2/pace.min.js"></script>
    <!--<script src="https://unpkg.com/bootstrap-table@1.17.1/dist/bootstrap-table.min.js"></script>-->
    <!--<script src="https://unpkg.com/bootstrap-table@1.17.1/dist/extensions/group-by-v2/bootstrap-table-group-by.min.js">
    </script>-->
    <script>
        var pieData = null;
        var pieChart = null;
        ...
        $(document).ready(() => {
            ...
            pieData = {
                labels: ['RECEPCION', 'SELECCIÓN', 'EMPAQUE', 'PRE PACK', 'EMBOLSADO', 'CÁMARA', 'CALIDAD',
                    'SANEAMIENTO', 'ALMACÉN', 'MANTENIMIENTO', 'INF. DE PRODUCCIÓN', 'PRODUCCIÓN',
                    'VIGILANCIA', 'TRANSPORTE', 'RECURSOS HUMANOS'
                ],
                datasets: [{
                    data: [5, 200, 400, 600, 300, 100, 700, 200, 400, 600, 300, 100, 600, 300, 100],
                    backgroundColor: ['blue', 'red', 'orange', 'black', 'yellow', 'violet', 'pink',
                        'bluelight', getRandomColor(), getRandomColor(), getRandomColor(),
        ...
        $('#daterange-btn').daterangepicker({
                ...
                ranges: {
                    ...
                    'Ultimo Mes': [moment().subtract(1, 'month').startOf('month'), moment().subtract(1, 'month').endOf(
                        'month')]
                },
                startDate: moment(),
                endDate: moment(),
        ...
        async function loadGraphics(start, end) {
            ...
            if (!user) {
                ...
                $.ajax({
                    url: url + '/home/loadPieCustomGraphics/' + start + '/' + end + '/' + sedes + '/0/' +
                        is_costo + '/' + proceso,
                    type: 'GET',
                    success: function(response) {
                        // console.log(response);
                        if (response.success) {
                            ...
                            updatePieData(response.data, response.labels, response.backgroundcolor, response
                                .hidden);
                        } else {
                            $('#total').text(0);
                            removePieData();
                ...
                $.ajax({
                    url: url + '/home/loadAssistancebyArea/' + start + '/' + end + '/' + sedes + '/0/' +
                        is_costo + '/0/' + exchangeRate + '/' + proceso,
                    type: 'GET',
                    success: function(response) {
                        // console.log(response);
                ...
                $.ajax({
                    url: url + '/home/loadAssistancebyUser/' + start + '/' + end + '/' + sedes + '/ALL/' +
                        proceso,
                    type: "get",
                    dataType: "json",
                ...
                //load areas by user
                $.ajax({
                    url: url + '/home/loadPieCustomGraphics/' + start + '/' + end + '/' + sedes + '/' + user +
                        "/" + is_costo,
                    type: 'GET',
                    success: function(response) {
                        // console.log(response);
                ...
                $.ajax({
                    url: url + '/home/loadAssistancebyArea/' + start + '/' + end + '/' + sedes + '/' + user +
                        "/" + is_costo,
                    type: 'GET',
                    success: function(response) {
                        console.log(response);
        ...
        function loadSummaryWorkers(id_area, id_sede) {
            ...
            var proceso = $('#cultivo').val();
            $.ajax({
                url: url + '/home/loadSummaryWorker/' + start_date + '/' + end_date + '/' + id_area + '/' +
                    proceso + '/' + id_sede + '/' + multiplicador,
                // dataType: 'json',
                type: 'get',
        ...
        function showBackOffice() {
            ...
            if (showOffice == false) {
                ...
                $.ajax({
                    url: url + '/home/loadBackOffice/' + start_date + '/' + end_date + '/' + sedes + '/0/' +
                        is_costo + '/' + proceso,
                    type: 'get',
                    dataType: 'json',
                    error: function(response) {
