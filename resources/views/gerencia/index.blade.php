...
@section('content')
    @include('layouts.navbars.auth.topnav', ['title' => 'Gerencia'])
            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header d-flex justify-content-start">
                        <h2>Gerencia</h2>
                        <button class="btn btn-primary m-1" onclick="create()">Agregar Gerencia</button>
                    </div>
                    <div class="card-body">
        ...
        <div class="modal-dialog modal-sm" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title">Nueva Gerencia</h4>
                </div>
                <form id="formcreate" action="{{ route('gerencia.create') }}" method="post">
                    {{ csrf_field() }}
        ...
        <div class="modal-dialog modal-sm" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span
                            aria-hidden="true"></span></button>
                    <h4 class="modal-title">Editar Gerencia</h4>
                </div>
...
@section('js')
    ...
    <script>
        ...
        function edit(id) {
            $.ajax({
                url: url + '/gerencia/update/' + id,
                type: 'GET',
                success: function(response) {
                    console.log(response);
                    $('#formupdate').attr('action', url + '/gerencia/update/' + id);
                    // $('#code-edit').val(response.data.code);
                    $('#name-edit').val(response.data.description);
