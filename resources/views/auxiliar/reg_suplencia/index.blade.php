...
@section('content')
    @include('layouts.navbars.auth.topnav', ['title' => 'Suplencia'])
            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header d-flex justify-content-start">
                        <h2>Suplencia</h2>
                        <button class="btn btn-primary m-1" onclick="create()">Agregar Suplencia</button>
                    </div>
                    <div class="card-body">
    ...
    <div class="modal fade" data-backdrop="static" data-keyboard="false" tabindex="-1" role="dialog" id="createModal">
        <div class="modal-dialog modal-sm" role="document">
            <div class="modal-content">
                ...
                <form id="formcreate" action="{{ route('TipoRegistro.create') }}" method="post">
                    {{ csrf_field() }}
                    <div class="modal-body">
                        <div class="row">
                            <div class="col-md-12">
                                <small>TipoRegistro</small>
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            manageTable = $('#manageTable').DataTable({
                ...
                ajax: {
                    type: 'get',
                    url: '{{ route('TipoRegistro.getTable') }}',
                    beforeSend: function() {
                        $('.progress').show();
                    },
                    complete: function() {
        ...
        function eliminar(id) {
            if (confirm('Estas seguro de eliminar este registro?')) {
                // Deleted it!
                $.ajax({
                    url: url + '/TipoRegistro/delete/' + id,
                    type: 'GET',
        ...
        function edit(id) {
            $.ajax({
                url: url + '/TipoRegistro/update/' + id,
                type: 'GET',
                success: function(response) {
                    console.log(response);
                    $('#formupdate').attr('action', url + '/TipoRegistro/update/' + id);
