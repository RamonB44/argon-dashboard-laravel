            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header d-flex justify-content-start">
                        <h2>Sedes</h2>
                        <button class="btn btn-primary m-1" onclick="create()">Agregar Sedes</button>
                    </div>
                    <div class="card-body">
    ...
    <div class="modal fade" data-backdrop="static" data-keyboard="false" tabindex="-1" role="dialog" id="createModal">
        <div class="modal-dialog modal-md" role="document">
            <div class="modal-content">
                ...
                <form id="formcreate" action="{{ route('sedes.create') }}" method="post">
                    {{ csrf_field() }}
                    <div class="modal-body">
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                ...
                                <select name="t_sede" class="form-control" id="t_sede">
                ...
                <form id="formupdate" method="post">
                    ...
                    <div class="modal-body">
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <small>Zona</small>
                                <select name="zona" id="zona-edit" class="form-control">
                                    <option>SUR</option>
                                    <option>NORTE</option>
                                </select>
                            </div>
                            <div class="col-md-4">
                                <small>Tipo Sede</small>
                                <select name="t_sede" class="form-control" id="t_sede-edit">
                                    <option>PLANTA</option>
                                    <option>FUNDO</option>
                                </select>
                            </div>
...
@section('js')
    ...
    <script>
        ...
        function edit(id) {
            $.ajax({
                url: url + '/sedes/update/' + id,
                type: 'GET',
                success: function(response) {
                    console.log(response);
                    $('#formupdate').attr('action', url + '/sedes/update/' + id);
                    // $('#code-edit').val(response.data.code);
                    $('#name-edit').val(response.data.name);
                    $('#t_sede-edit').val(response.data.t_sede);
                    $('#zona-edit').val(response.data.zona);
