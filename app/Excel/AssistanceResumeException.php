...
class AssistanceResumeException implements FromArray, WithHeadings,WithEvents,ShouldAutoSize,WithColumnFormatting,WithTitle
{
    //
    protected $invoices;
    protected $headings;
    ...
    {
        return 'Asistencia Resumen Excepciones';
    }
}
